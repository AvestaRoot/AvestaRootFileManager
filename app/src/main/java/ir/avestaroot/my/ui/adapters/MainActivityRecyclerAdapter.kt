...
class MainActivityRecyclerAdapter(
    ...
    inner class MediaViewHolder(private val binding: MainActivityMediaViewholderBinding) : ViewHolder(binding.root) {
    ...
    inner class StorageViewHolder(private val binding: MainActivityStorageViewholderBinding) : ViewHolder(binding.root) {
        fun bind(position: Int) {
    ...
    override fun onCreateViewHolder(
        ...
        return when(viewType) {
            MEDIA_VIEWHOLDER -> MediaViewHolder(MainActivityMediaViewholderBinding.inflate(inflater, parent, false))

//            STORAGE_VIEWHOLDER
            else -> StorageViewHolder(MainActivityStorageViewholderBinding.inflate(inflater, parent, false))
        }
    }
