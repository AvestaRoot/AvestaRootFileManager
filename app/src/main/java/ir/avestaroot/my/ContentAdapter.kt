...
class ContentAdapter(private val mList: List<ItemsViewModel>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.name_fl_tv.text = item.name_fl_tv
        holder.date_fl_tv.text = item.date_fl_tv
        holder.tv_items.text = item.tv_items
